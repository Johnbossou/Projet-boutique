        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 top-full mt-2 z-50 w-80 sm:w-96 max-w-[calc(100vw-1rem)] overflow-hidden rounded-2xl border bg-white dark:bg-slate-900 shadow-2xl"
            >
              {/* Header */}
